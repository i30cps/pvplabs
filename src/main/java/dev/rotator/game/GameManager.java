...
public class GameManager {
    ...
    public void startMoleGame(ArrayList<Player> team1, ArrayList<Player> team2) {
        Kit moleKit = PvPLabs.getMain().getKitManager().getKit("mole");

        KitDuelGame game = makeKitDuelGame(team1, team2, moleKit, moleKit, new KitDuelMap(
                "Mole", "maps/MoleMap.schem", 64, 64, new org.bukkit.util.Vector(16, 10, 5), new Vector(16, 10, 27)
        ));
